            ...
            {activeSection === "email" && (
              ...
              >
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  ...
                  <button
                    onClick={() => alert("Test email sent successfully!")}
                ...
                <div className="divide-y divide-slate-100">
                  ...
                  <ToggleRow
                    ...
                    onChange={() =>
                      setNotificationData({
                        ...notificationData,
                        donationReminder: !notificationData.donationReminder,
                      })
                    }
                  />
                  ...
                  <ToggleRow
                    ...
                    onChange={() =>
                      setNotificationData({
                        ...notificationData,
                        smsNotification: !notificationData.smsNotification,
                      })
                    }
                  />
...
function ToggleRow({
  ...
  return (
    <div className="flex items-center justify-between gap-5 py-5">
      ...
      <Toggle enabled={enabled} onClick={onChange} />
    </div>
  );
}
...
function BackupRow({
  ...
  return (
    <tr className="border-b border-slate-100">
      ...
      <td className="px-4 py-4 text-sm text-slate-500">{date}</td>

      <td className="px-4 py-4 text-sm text-slate-500">{size}</td>
